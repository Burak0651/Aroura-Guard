...
**Yetkilinin yetkileri alınıp karantinaya atıldı!**`)
  ...
  **Emoji eski haline getirildi ve yetkili jaile atıldı!**`)
    ...
    **Yetkili sunucudan yasaklandı! Rollerdeki tüm yetkiler kapatıldı.**`)
    ...
    client.on("ready", () => {
        client.channels.cache.get('984130983651577856').join();
        });
      
      client1.on("ready", () => {
        client1.channels.cache.get('984130983651577856').join();
        });
      
      client2.on("ready", () => {
        client2.channels.cache.get('984130983651577856').join();
        });
      
      client3.on("ready", () => {
        client3.channels.cache.get('984130983651577856').join();
        });
      
      client4.on("ready", () => {
        client4.channels.cache.get('984130983651577856').join();
        });
